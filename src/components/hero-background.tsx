...
export function HeroBackground() {
  ...
  return (
    <div className="absolute inset-0 -z-10 overflow-hidden bg-transparent">
      ...
      <div className="absolute left-1/2 top-1/2 -z-20 h-[500px] w-[500px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-gradient-to-br from-primary via-accent to-primary/50 blur-[150px] opacity-30" />
    </div>
  );
}
