  ...
  useEffect(() => {
    ...
    const fragmentShader = `
      ...
      void main() {
        ...
        vec3 gridColor = vec3(0.5, 0.7, 1.0); // Light blue
        ...
        color += vec3(0.9, 0.6, 1.0) * energy * line; // Lavender pulse

        // glow around mouse
        float glow = smoothstep(0.1, 0.0, mouseDist);
        color += vec3(0.8, 0.9, 1.0) * glow * 0.5; // Light blue glow
    ...
    const onMouseMove = (e: MouseEvent) => {
        ...
        uniforms.iMouse.value.set(
            e.clientX,
            containerRef.current.clientHeight - e.clientY
        );
    };
